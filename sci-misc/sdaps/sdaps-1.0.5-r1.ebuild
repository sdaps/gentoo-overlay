...
DEPEND="dev-python/python-distutils-extra media-libs/tiff"
DEPEND="${DEPEND} dev-python/pycairo || ( dev-python/pyPdf app-text/pdftk )"
RDEPEND="x11-libs/gtk+ dev-python/pygobject 
 || ( dev-python/pillow dev-python/imaging ) dev-python/reportlab 
media-gfx/zbar[python]"
